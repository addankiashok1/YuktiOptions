...
from app.api.v1.endpoints import auth, market, orders, wallet, positions, emotion, ws, portfolio, orderbook
...
router.include_router(orderbook.router, prefix="/orderbook", tags=["orderbook"])
